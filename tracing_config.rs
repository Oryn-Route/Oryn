...
//! | `OTEL_SERVICE_NAME`      | Service name for spans        | `orynroute`   |
...
impl Default for TracingConfig {
    fn default() -> Self {
        Self {
            service_name: "orynroute".to_string(),
            otlp_endpoint: None,
            sampling_ratio: 1.0,
...
impl TracingConfig {
    pub fn from_env() -> Self {
        let service_name = env::var("OTEL_SERVICE_NAME").unwrap_or_else(|_| "orynroute".into());

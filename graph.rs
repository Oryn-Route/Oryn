...
use std::sync::Arc;
use orynroute_routing::health::anomaly::LiquidityAnomalyDetector;
use orynroute_routing::pathfinder::LiquidityEdge;
    ...
    pub fn new(db: PgPool) -> Self {
        Self {
            ...
            anomaly_detector: Arc::new(tokio::sync::Mutex::new(
                orynroute_routing::health::anomaly::LiquidityAnomalyDetector::new(
                    orynroute_routing::health::anomaly::AnomalyConfig::default(),
                ),
            )),
        }
    }

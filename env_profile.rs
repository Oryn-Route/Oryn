...
//!
//! `ORYNROUTE_ENV=production` is the single source of truth for "this is
...
/// Whether `ORYNROUTE_ENV` is set to `production` (case-insensitive).
pub fn is_production() -> bool {
    std::env::var("ORYNROUTE_ENV")
...
mod tests {
    ...
    fn is_production_true_only_for_production_value() {
        ...
        std::env::set_var("ORYNROUTE_ENV", "staging");
        assert!(!is_production());

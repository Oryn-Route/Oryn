...
#[openapi(
    paths(
        ...
        crate::routes::intents::create_intent,
        crate::routes::intents::get_intent,
        crate::routes::intents::open_auction,
        crate::routes::intents::register_solver,
        crate::routes::intents::get_solver,
        crate::routes::intents::submit_quote,
        crate::routes::intents::auction_status,
        crate::routes::intents::settle_auction,
    ),
    components(schemas(
        HealthResponse,
        ...
        crate::models::intent::SolverStatus,
        crate::models::intent::RoundStatus,
        crate::models::intent::CreateIntentRequest,
        crate::models::intent::CreateIntentResponse,
        crate::models::intent::IntentResponse,
        crate::models::intent::OpenAuctionResponse,
        crate::models::intent::RegisterSolverRequest,
        crate::models::intent::SolverResponse,
        crate::models::intent::SubmitQuoteRequest,
        crate::models::intent::SolverQuoteResponse,
        crate::models::intent::AuctionStatusResponse,
        crate::models::intent::SettleAuctionRequest,
        crate::models::intent::SettleAuctionResponse,
    )),
    tags(
        ...
        (name = "ofa", description = "Stellar-native order flow auction: submit intents, open 2-3s auctions, register bonded solvers, submit quotes, settle winners."),
    ),
    info(
        title = "OrynRoute API",
        version = "0.1.0",
        ...
        contact(
            name = "OrynRoute",
            url = "https://github.com/orynroute/orynroute"
        ),
        license(
            name = "MIT",
        ),

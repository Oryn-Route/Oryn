...
//!
//! Usage:
//!   cargo run -p orynroute-api --bin cctp-live-readiness-probe
//!   SIMULATE_SOURCE=G... cargo run -p orynroute-api --bin cctp-live-readiness-probe

use orynroute_api::cctp::config::CctpConfig;
use orynroute_api::cctp::stellar_builder_simulation::probe_strict_simulation_assembly_with_evidence;
use orynroute_api::cctp::stellar_readiness_probes::probe_stellar_contracts;

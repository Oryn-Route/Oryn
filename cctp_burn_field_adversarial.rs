...
use orynroute_api::cctp::attestation::NotReadyAttestationVerifier;
use orynroute_api::cctp::config::CctpConfig;
use orynroute_api::cctp::expectations::build_expected_burn_facts;
...
use orynroute_api::cctp::store::{CctpTransferStore, InMemoryCctpTransferStore};
use orynroute_api::cctp::verifiers::{
    FakeBurnVerifier, NotReadyEvmBurnVerifier, NotReadyStellarBurnVerifier, VerifiedBurnFacts,
};
use orynroute_api::kill_switch::KillSwitchManager;
...
impl IrisClient for MockIris {
    async fn fetch_burn_fees(
        ...
        _: u32,
        _: u32,
    ) -> Result<orynroute_api::cctp::iris::IrisFeeQuote, orynroute_api::cctp::iris::IrisError>
    {
        Ok(IrisFeeQuote {
            standard_fee: "1".into(),
            fast_fee: None,
...
) -> orynroute_api::cctp::store::CctpTransfer {
    ...
    let (stellar, evm) = match direction {
        CctpDirection::StellarToEvm => (
            Arc::new(FakeBurnVerifier {
                facts: stub,
                ready: true,
            }) as Arc<dyn orynroute_api::cctp::verifiers::StellarBurnVerifier>,
            Arc::new(NotReadyEvmBurnVerifier)
                as Arc<dyn orynroute_api::cctp::verifiers::EvmBurnVerifier>,
        ),

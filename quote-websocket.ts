 ...
 *
 * This example demonstrates how to use the OrynRouteWebSocket client with
 ...
 * (Requires a running OrynRoute API server with WebSocket support)
 */

import { OrynRouteWebSocket, createWebSocketClient, WebSocketState } from '../src/index.js';

const API_URL = process.env.ORYNROUTE_WS_URL ?? 'ws://localhost:3000';

async function main(): Promise<void> {
  console.log('🔌 OrynRoute WebSocket Reconnection Example');
  console.log('==============================================\n');

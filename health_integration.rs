...
//!   DATABASE_URL=postgres://... cargo test -p orynroute-api --test health_integration -- --ignored
...
fn health_response_serializes_to_spec_shape() {
    ...
    use orynroute_api::models::HealthResponse;
...
fn dependencies_health_response_serializes_to_spec_shape() {
    use std::collections::HashMap;
    use orynroute_api::models::DependenciesHealthResponse;

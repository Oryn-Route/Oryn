...
mod multi_region_tests {
    ...
    fn test_health_status_transitions() {
        ...
        let checker =
            orynroute_api::regions::health::RegionHealthCheck::new(RegionId::UsEast, config);
    ...
    fn test_replica_lag_detection() {
        ...
        let checker =
            orynroute_api::regions::health::RegionHealthCheck::new(RegionId::EuWest, config);
    ...
    fn chaos_test_health_check_rapid_oscillation() {
        ...
        let checker = orynroute_api::regions::health::RegionHealthCheck::new(

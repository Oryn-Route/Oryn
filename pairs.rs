...
//! canonical pair ordering defined in [`orynroute_routing::normalize_pair`].
...
///
/// Uses [`orynroute_routing::normalize_pair`] as the single source of
...
pub(crate) fn normalize_pair_infos(
    ...
    match orynroute_routing::normalize_pair(&selling_canonical, &buying_canonical) {

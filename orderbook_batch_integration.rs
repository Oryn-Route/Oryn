...
fn item_result_error_shape() {
    use orynroute_api::models::{BatchItemError, BatchOrderbookItemResult};
...
fn batch_max_items_constant_is_25() {
    use orynroute_api::routes::orderbook::BATCH_MAX_ITEMS;
    assert_eq!(
        BATCH_MAX_ITEMS, 25,
...
fn orderbook_request_item_validate_rejects_same_base_quote() {
    use orynroute_api::models::request::OrderbookRequestItem;

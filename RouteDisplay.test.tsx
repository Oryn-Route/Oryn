...
describe('RouteDisplay — telemetry', () => {
  ...
  it('emits telemetry event on alternative route selection', async () => {
    ...
    window.addEventListener('orynroute:route-selected', telemetryListener as EventListener);
    ...
    try {
      ...
      window.removeEventListener('orynroute:route-selected', telemetryListener as EventListener);
    }
  });

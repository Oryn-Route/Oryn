...
describe('Multi-tab Wallet State Sync Detection', () => {
  ...
  it('should show sync banner when wallet is connected in another tab', async () => {
    ...
    act(() => {
      window.localStorage.setItem('orynroute.wallet.address', 'GABC123DEFGHIJKLMNOPQRSTUVWXYZ456789ABCDEFGHIJKLMNOPQRSTUVWXYZ');
      window.localStorage.setItem('orynroute.wallet.walletId', 'freighter');
      
      const storageEvent = new StorageEvent('storage', {
        key: 'orynroute.wallet.address',

...
pub enum StorageKey {
    ...
    AllowedToken(Asset),
    // ── Solver Registry Keys ────────────────────────────────────────────────
    SolverRegistryConfig,
    Solver(Address),
    SolverCount,
    Auction(BytesN<32>),
    AuctionQuote(BytesN<32>, Address),
    AuctionWinner(BytesN<32>),
}
...
/// Solver registry persistent storage TTLs (+90 days)
pub const SOLVER_TTL_EXTEND_TO: u32 = 90 * DAY_IN_LEDGERS;
pub const SOLVER_TTL_THRESHOLD: u32 = 22 * DAY_IN_LEDGERS;
pub const AUCTION_TTL_EXTEND_TO: u32 = 30 * DAY_IN_LEDGERS;
pub const AUCTION_TTL_THRESHOLD: u32 = 7 * DAY_IN_LEDGERS;

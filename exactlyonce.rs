...
impl RequestIdentity {
    ...
    /// [`orynroute_routing::normalize_asset`] so that equivalent forms
    ...
    pub fn canonical_key(&self) -> String {
        let base = orynroute_routing::normalize_asset(&self.base_asset);
        let quote = orynroute_routing::normalize_asset(&self.quote_asset);
        format!(
            "{}/{}:{}:{}:{}",

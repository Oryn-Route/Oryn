...
use orynroute_api::cctp::builders::{
    BuilderError, BurnPrepareStep, PreparedBurnBundle, StellarCctpBurnBuilder,
};
use orynroute_api::cctp::config::CctpConfig;
use orynroute_api::cctp::iris::{IrisClient, IrisError, IrisFeeQuote, IrisPollOutcome};
use orynroute_api::cctp::prepare_lock::InMemoryCctpPrepareLockStore;
...
#[async_trait]
impl orynroute_api::cctp::verifiers::StellarBurnVerifier for ReadyBurnVerifier {
    fn is_ready(&self) -> bool {
        true
    }
    ...
    async fn verify_burn(
        ...
        orynroute_api::cctp::verifiers::VerifiedBurnFacts,
        orynroute_api::cctp::verifiers::VerifierError,
    > {
        Err(orynroute_api::cctp::verifiers::VerifierError::NotReady)
    }
}

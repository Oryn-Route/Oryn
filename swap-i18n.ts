...
> = {
  "en-US": {
    ...
    "swap.fees.routerFee.description":
      "Fee for using OrynRoute aggregator",
    ...
    "swap.card.poweredBy": "Powered by OrynRoute Aggregator",
    ...
    "settings.appearance.description": "Customize how OrynRoute looks on your device.",
    ...
    "settings.textSize.preview.title": "Preview — OrynRoute",
    ...
    "swap.fees.routerFee.description": "Comisión por usar el agregador OrynRoute",
    ...
    "swap.card.poweredBy": "Desarrollado por OrynRoute Aggregator",
  ...
  "zh-CN": {
    ...
    "swap.fees.routerFee.description": "使用 OrynRoute 聚合器的费用",
    ...
    "swap.card.poweredBy": "由 OrynRoute 聚合器提供支持",
    ...
    "settings.appearance.description": "自定义 OrynRoute 在你设备上的显示方式。",
    ...
    "settings.textSize.preview.title": "预览 — OrynRoute",

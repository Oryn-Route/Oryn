#!/usr/bin/env python3
"""
OrynRoute API Synthetic Monitoring Probes
============================================
...
def make_request(url: str, timeout: float, verbose: bool = False) -> tuple[int, bytes, float, str | None]:
    ...
    req = urllib.request.Request(
        ...
        headers={
            ...
            "User-Agent": "OrynRoute-SyntheticProbe/1.0",
        }
    )
...
def validate_envelope(payload: dict) -> str | None:
    """Validates the standard OrynRoute API envelope shape: v, timestamp, request_id, data."""
...
def main():
    ...
    parser = argparse.ArgumentParser(
        description="OrynRoute API Synthetic Probes Runner",

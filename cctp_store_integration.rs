...
//! Run with isolated local Postgres: `TEST_DATABASE_URL=postgres://... cargo test -p orynroute-api --test cctp_store_integration -- --ignored`
...
use orynroute_api::models::v2_cctp::{CctpDirection, CctpFinality, CctpTransferStatus};
use uuid::Uuid;

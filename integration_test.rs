...
use orynroute_indexer::db::Database;
use orynroute_indexer::models::asset::Asset;
use orynroute_indexer::soroban::{SorobanRpc, SorobanRpcClient};
use tracing::debug;
...
async fn test_database_connection() {
    let config = IndexerConfig {
        ...
        horizon_mode: orynroute_indexer::config::HorizonMode::Poll,
...
async fn test_soroban_client_get_latest_ledger() {
    let client =
        SorobanRpcClient::for_network(orynroute_indexer::soroban::StellarNetwork::Testnet)

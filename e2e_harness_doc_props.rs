...
//!   cargo test -p orynroute-contracts e2e_harness_doc_props
...
// The `extern crate std` below opts this module back into std so host I/O and
// formatting macros are available.
...
mod tests {
    ...
    fn prop_run_command_present() {
        ...
        assert!(
            guide.contains("cargo test -p orynroute-contracts e2e"),

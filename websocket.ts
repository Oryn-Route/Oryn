...
export class OrynRouteWebSocket {
  ...
  private log(...args: unknown[]): void {
    if (this.options.debug) {
      console.log('[OrynRouteWebSocket]', ...args);
    }
  }
}
 ...
 */
export function createWebSocketClient(baseUrl?: string, options?: WebSocketOptions): OrynRouteWebSocket {
  return new OrynRouteWebSocket(baseUrl, options);
}
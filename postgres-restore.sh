...
# Example:
#   sudo bash deploy/aws/scripts/postgres-restore.sh /var/backups/orynroute-postgres/orynroute-20260803T120000Z.sql.gz --yes
set -euo pipefail

ROOT="$(cd "$(dirname "${BASH_SOURCE[0]}")/../../.." && pwd)"
ENV_FILE="${ROOT}/.env.prod"
CONTAINER_NAME="${POSTGRES_CONTAINER_NAME:-orynroute-postgres}"

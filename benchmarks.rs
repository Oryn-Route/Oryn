// NOTE: This crate is #![no_std]; opt back into std for the host test harness.
extern crate std;

use crate::router::{OrynRoute, OrynRouteClient};
...
fn bench_initialize() {
    ...
    let contract_id = env.register_contract(None, OrynRoute);
    let client = OrynRouteClient::new(&env, &contract_id);

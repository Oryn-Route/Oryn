...
use std::sync::Arc;
use orynroute_api::models::request::AssetPath;
use orynroute_api::routes::simulation_route::{RouteDryRunHop, RouteDryRunPath};
use orynroute_api::{
    audit::AuditRedactor,
...
async fn make_submit_router(
    ...
    orynroute_api::routes::create_router(app_state.into_arc())
}

...
describe('WalletProvider Account Switching', () => {
  ...
  it("persists auto reconnect preference changes", async () => {
    ...
    expect(
      window.localStorage.getItem("orynroute.wallet.autoReconnect"),
    ).toBe("false");
  ...
  it("auto reconnects on mount when preference is enabled and a wallet was previously used", async () => {
    window.localStorage.setItem("orynroute.wallet.autoReconnect", "true");
    window.localStorage.setItem("orynroute.wallet.lastWalletId", "freighter");
  ...
  it("does not auto reconnect on mount when preference is disabled", async () => {
    window.localStorage.setItem("orynroute.wallet.autoReconnect", "false");
    window.localStorage.setItem("orynroute.wallet.lastWalletId", "freighter");

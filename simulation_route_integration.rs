...
//!
//! ```sh
//! DATABASE_URL=postgres://orynroute:orynroute_dev@localhost:5432/orynroute \
//!   cargo test -p orynroute-api --test simulation_route_integration -- --ignored
//! ```
...
/// Run with: `cargo test -p orynroute-api --test simulation_route_integration -- --ignored`
#[tokio::test]

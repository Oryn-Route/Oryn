...
const capabilities = [
  ...
  },
  {
    ...
    description:
      'OrynRoute builds the path. Your connected wallet reviews and signs the execution.',
    icon: Lock,
  },
  {
    eyebrow: '03 / BRIDGE',

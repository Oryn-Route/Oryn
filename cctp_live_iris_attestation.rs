...
//! Run: `cargo test -p orynroute-api --test cctp_live_iris_attestation -- --ignored --nocapture`

use std::sync::Arc;
use std::time::Duration;

use chrono::{Duration as ChronoDuration, Utc};
use orynroute_api::cctp::attestation::{AttestationVerifier, CircleAttestationVerifier};
use orynroute_api::cctp::attestation_trust::{
    AttestationRefreshDeps, AttestationTrustCache, SystemClock,
};
use orynroute_api::cctp::config::CctpConfig;
use orynroute_api::cctp::evm_attester_reader::evm_reader_arc;
use orynroute_api::cctp::expectations::build_corridor_expectations;
use orynroute_api::cctp::iris::{IrisClient, IrisPollOutcome, ReqwestIrisClient};
use orynroute_api::cctp::iris_public_keys::ReqwestIrisPublicKeySource;
use orynroute_api::cctp::message::{decode_hex_message, validate_message_for_corridor};
use orynroute_api::cctp::stellar_attester_reader::stellar_reader_arc;
use orynroute_api::cctp::store::CctpTransfer;

...
#   AWS_REGION=us-east-1 STAGING_INSTANCE_NAME=orynroute-staging-ec2 bash deploy/aws/scripts/ec2-staging-start.sh
set -euo pipefail

AWS_REGION="${AWS_REGION:-us-east-1}"
STAGING_INSTANCE_ID="${STAGING_INSTANCE_ID:-}"
STAGING_INSTANCE_NAME="${STAGING_INSTANCE_NAME:-orynroute-staging-ec2}"

...
import { OrynRouteWebSocket, createWebSocketClient, WebSocketState, Clock, IWebSocket, IWebSocketFactory } from './websocket.js';
...
describe('OrynRouteWebSocket', () => {
  let client: OrynRouteWebSocket;
  let clock: Clock;
  ...
  beforeEach(() => {
    ...
    client = new OrynRouteWebSocket('ws://localhost:8080', {
...
describe('createWebSocketClient', () => {
  it('should create a client with default options', () => {
    ...
    expect(client).toBeInstanceOf(OrynRouteWebSocket);
  });
});
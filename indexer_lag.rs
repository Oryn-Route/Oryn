...
//! |-------------------------------------------|---------|---------|--------------------------------------------------|
//! | `orynroute_indexer_lag_ledgers`        | Gauge   | `source`| Ledger count behind Horizon (`sdex` / `amm`)     |
//! | `orynroute_indexer_lag_seconds`        | Gauge   | `source`| Estimated wall-clock lag in seconds              |
//! | `orynroute_indexer_last_indexed_ledger`| Gauge   | `source`| Most recently indexed ledger sequence number     |
//! | `orynroute_indexer_horizon_ledger`     | Gauge   | —       | Current Horizon latest ledger (cached)           |
//! | `orynroute_indexer_sync_status`        | Gauge   | `source`| 1 = ok, 0 = warning, -1 = critical               |
//!

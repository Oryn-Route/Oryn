#!/bin/bash
# OrynRoute — Idempotent Pool Registration with Router Contract
#
...
#   ROUTER_CONTRACT_ADDRESS  — or ORYNROUTE_TESTNET_ROUTER_ID / SOROBAN_CONTRACT_ID
...
CONTRACT_ID="${ROUTER_CONTRACT_ADDRESS:-${ORYNROUTE_TESTNET_ROUTER_ID:-${SOROBAN_CONTRACT_ID:-}}}"
...
if [[ -z "${CONTRACT_ID}" ]]; then
    ...
    log_error "Set ROUTER_CONTRACT_ADDRESS, ORYNROUTE_TESTNET_ROUTER_ID,"
